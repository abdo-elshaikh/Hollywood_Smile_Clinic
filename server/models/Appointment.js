...
const AppointmentSchema = new Schema({
    ...
    doctor: { type: mongoose.Schema.Types.ObjectId, ref: 'User', required: true },  // Link to the User model
    ...
    status: { type: String, enum: ['pending', 'inProgress', 'completed', 'cancelled'], default: 'pending' },  // Status of the appointment
